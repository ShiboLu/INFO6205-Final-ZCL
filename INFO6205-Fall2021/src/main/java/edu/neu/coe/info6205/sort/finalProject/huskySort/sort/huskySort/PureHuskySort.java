...
import edu.neu.coe.info6205.sort.finalProject.huskySort.sort.huskySortUtils.Coding;
...
import edu.neu.coe.info6205.sort.finalProject.huskySort.sort.simple.InsertionSort;
...
public class PureHuskySort<X extends Comparable<X>> {
    public static void main(String[] args) {
        ...
        test.PureHuskySortTest(999998);
    }

    public static void PureHuskySortTest(int n) {
...
//        }
        ...
        wt.writeTxt("PureHuskySorted.txt", result, 1000);
    }
